      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 animate-slide-up">
          ...
          <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
            <span className="text-primary font-semibold">NUTRIBLITZ</span> se especializa en la creación de 
            suplementos nutricionales de calidad premium que transforman las comidas rápidas en rutinas energéticas. 
            Combinamos superalimentos como maca, avena, cacao y plátano rico en potasio para entregar polvos listos 
            para mezclar que brindan energía, sacian el hambre y apoyan el bienestar a largo plazo.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="animate-slide-up">
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              Fundada en 2025, <strong className="text-primary">NUTRIBLITZ</strong> nació en respuesta a la creciente 
              demanda de opciones de comida rápida sin comprometer la calidad nutricional. Nuestros productos están 
              formulados con ingredientes premium como cacao, maca, avena y plátano, enriquecidos con vitaminas y minerales.
            </p>
            <p className="text-muted-foreground mb-8 leading-relaxed">
              Dirigido a profesionales y personas activas que priorizan su salud sin sacrificar su tiempo, 
              <strong className="text-primary"> NUTRIBLITZ</strong> es más que un suplemento: es un aliado estratégico 
              para un estilo de vida activo y equilibrado.
            </p>
